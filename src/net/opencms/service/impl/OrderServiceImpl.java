...
import net.opencms.entity.OrderLog.Type;
...
import net.opencms.entity.ReturnsItem;
import net.opencms.entity.Shipping;
import net.opencms.entity.ShippingItem;
import net.opencms.entity.ShippingMethod;
import net.opencms.entity.Sn;
...
public class OrderServiceImpl extends BaseServiceImpl<Order, Long> implements OrderService {
	...
	@Transactional(readOnly = true)
	public List<Order> findList(Member member, Integer count, List<Filter> filters, List<net.opencms.Order> orders) {
