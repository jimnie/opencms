...
import net.opencms.EnumConverter;
...
public final class SettingUtils {
	...
	public static Setting get() {
		...
		if (cacheElement != null) {
			...
			setting = new Setting();
			try {
				File cmsXmlFile = new ClassPathResource(CommonAttributes.CMS_CONFIG_PATH).getFile();
				Document document = new SAXReader().read(cmsXmlFile);
				List<Element> elements = document.selectNodes("/opencms/setting");
	...
	public static void set(Setting setting) {
		try {
			...
			Document document = new SAXReader().read(opencmsXmlFile);
			List<Element> elements = document.selectNodes("/opencms/setting");
			for (Element element : elements) {
				try {
					String name = element.attributeValue("name");
			...
			try {
				...
				fileOutputStream = new FileOutputStream(opencmsXmlFile);
